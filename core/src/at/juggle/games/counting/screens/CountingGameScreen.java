...
import at.juggle.games.counting.GameModel;
...
//        }
    ...
    private void handleInput() {
        ...
        if (Gdx.input.justTouched()) {
            ...
            GameModel.InputResult inputResult = model.handleTouch(touchWorldCoords);
            if (inputResult == GameModel.InputResult.Change) {
                model.resetGameState();
            } else if (inputResult == GameModel.InputResult.Pop) {
