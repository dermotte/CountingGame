...
public class CreditsScreen extends ScreenAdapter {
    ...
    public CreditsScreen(CountingGame game) {
    ...
    public void render(float delta) {
        ...
        batch.draw(gradientTop, 0, CountingGame.GAME_HEIGHT-gradientTop.getHeight(), CountingGame.GAME_WIDTH, gradientTop.getHeight());
